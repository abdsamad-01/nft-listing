...
const Modal = ({ nft, onClose }) => {
    return (
        <div className="absolute flex md:flex-row lg:mx-auto left-0 right-0 h-fit flex-col gap-3 bg-primary rounded-md lg:h-[40vh] lg:pb-0 pb-4 mx-3 lg:w-[550px] w-full shadow-sm items-center justify-center z-50 text-gray-50">
            ...
            <div className='lg:w-1/2 w-full lg:h-full'>
                <img className='lg:h-full w-full object-cover' src={nft.image} alt={nft.title} />
            </div>

            <div className='lg:w-1/2 w-full px-4'>
                <h3 className='text-[17px] pb-2'>{nft.title}</h3>
